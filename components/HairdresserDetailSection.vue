    ...
    <v-container fluid>
      <v-row align="center" justify="center">
        <v-col cols="12" sm="10" md="9" lg="7" xl="6">
          ...
          <h1 class="font-weight-bold my-3">詳細情報</h1>
          <v-data-table
            :headers="headers"
            :items="informations"
            hide-default-header
...
export default {
  ...
  created() {
    ...
    const phoneNumber = {
      category: '電話番号',
      information: this.phoneNumber,
    }
    this.informations.push(phoneNumber)
    // エリア代入
    const area = {
      category: '対応可能エリア',
      information: this.area,
    }
    this.informations.push(area)
    // 営業時間代入
    const time = {
      category: '営業時間',
      information: `${this.startTime} ~ ${this.endTime}`,
    }
